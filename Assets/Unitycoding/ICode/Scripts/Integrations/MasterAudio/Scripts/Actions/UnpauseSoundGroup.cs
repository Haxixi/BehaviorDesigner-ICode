...
namespace ICode.Actions{
	...
	[Tooltip("Unpause a Sound Group in Master Audio")] 
	[System.Serializable]
	public class UnpauseSoundGroup : StateAction
	{
		...
		public override void OnEnter()
		{
			...
			if (allGroups.Value) {
				...
				for (var i = 0; i < groupNames.Count; i++) {
					DarkTonic.MasterAudio.MasterAudio.UnpauseSoundGroup(groupNames[i]);
				}
			} else {
				DarkTonic.MasterAudio.MasterAudio.UnpauseSoundGroup(soundGroupName.Value);
			}
		}
	}
}
